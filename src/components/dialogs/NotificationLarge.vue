<template>
  <div
    class="w-screen h-screen fixed top-0 left-0 z-20"
    @click="$emit('close')"
  ></div>

  <div
    class="absolute hidden lg:block right-[11px] top-[60px] h-auto sm:w-[500px] lg:w-[600px] 2xl:w-[960px] bg-black h-auto max-h-[800px] z-20 rounded-xl overflow-y-scroll"
  >
    <header
      ...
      >
        <div class="flex items-center">
          ...
          <div class="flex flex-col items-start ml-[16px]">
            <p class="text-white text-[16px] xl:text-[20px] mb-2">
            ...
            <div class="flex items-center">
              ...
              <p
                ...
                class="text-white text-[16px] xl:text-[20px] ml-2 whitespace-nowrap"
              >
        ...
        <div class="flex flex-col">
          <p class="text-white text-[16px] xl:text-[20px]">
            {{ timeAgo(notification.created_at) }}
          </p>
          <p
            v-if="notification.read === 0"
            class="text-green-400 text-[16px] xl:text-[20px]"
          >
